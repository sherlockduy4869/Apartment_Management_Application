...
namespace QuanlyCanHoGiangTran.SHOW_INFO_FORM
{
    public partial class Negotiation : Form
    {
        ...
        void listApartNegotiate()
        {
            ...
            dtgvNegotiateApart.DataSource = DataProvider.Instance.ExecuteQuery("SELECT TENCHUHO,MACANHO,DUAN,TIENTHUEMOTTHANG,NGAYBATDAU,NGAYKETTHUC,STATUS FROM APARTMENT_CONTRACT " +
