...
--TABLE INCLUDES INFORMATION OF APARTMENT_FINANCE_INCOME
CREATE TABLE APARTMENT_FINANCE_INCOME
(
	STT INT IDENTITY,
	MACANHO NVARCHAR(25),
	THUE FLOAT,
...
BEGIN
	...
	DELETE FROM APARTMENT_FINANCE_INCOME WHERE MACANHO = @macanho
END
GO
...
BEGIN
	...
	UPDATE APARTMENT_FINANCE_INCOME
	SET STATUS_THUE = '0', STATUS_PHIKEKHAITHUE = '0', STATUS_PHIQUANLY= '0', 
		STATUS_TIENREFUNDKHACH = '0', STATUS_PHIDONVESINH = '0', STATUS_TIENTHU  = '0'
	WHERE MACANHO = @macanho
...
--TRIGGER FOR ADDING INFORMATION FOR APARTMENT_FINANCE_INCOME
CREATE TRIGGER ADDING_APARTMENT_INCOME
ON APARTMENT_INFO
FOR INSERT
AS
BEGIN
	...
	INSERT INTO APARTMENT_FINANCE_INCOME(MACANHO, THUE, PHIKEKHAITHUE, PHIQUANLY, TIENREFUNDKHACH, PHIDONVESINH, TIENTHU) 
	VALUES(@macanho, @thue, @phikekhaithue, @phiquanly, @tienrefundkhach, @phidonvesinh, @tienthu)
